...
def perform_action():
    ...
    print(config.get("suite"))
    print(config.get("browser"))
    print(config.get("user_type"))
    print(config.get("environment"))
    print(config.get("detailed_testing"))
    print(config.get("company_id"))
    print(config.get("number_of_companies"))
    print(config.get("ui_pages"))
    print(config.get("api_pages"))
    print(config.get("headless"))
